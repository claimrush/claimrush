...
Identity:
- Deployment name (manifest selector): `base_mainnet.template`
- Chain ID: `8453`
- Explorer: BaseScan (`https://basescan.org`)

Constraints (required):
- The runtime source of truth is `deployments/base_mainnet.template.json` (repo root), which the app loads at runtime.
- This doc MUST match the repo-root deployment manifests for all shared fields:
  - `deployments/base_mainnet.template.json`
  - `deployments/base_mainnet.template.md`
...
|---|---:|---:|
| DelegationHub | `0x0000000000000000000000000000000000000000` | `0` |
