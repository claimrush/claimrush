...
- Duration-based listing settlement penalty (mirrors Furnace round-trip loss: 25% at 365d, ~0.5% at 7d) — the retained cut is surfaced as `penalty = lockAmount - claimOut`, not a protocol fee
